...
//#include <numeric>
//
//KDTree::KDTree(const vector<GpsCoordinate> &coordinates) :
...
//}
//
//int KDTree::NNSearch(const GpsCoordinate&target) const
//{
//    int          best_node  = -1;
...
//}
//
//vector<int> KDTree::RadiusSearch(const GpsCoordinate&source, const double &radius) const
//{
//    vector<int>  nodes;
...
//        return;
//
//    const GpsCoordinate&current_point   = coordinates[current_node];
//    const double current_lat      = current_point.GetLat();
//    const double current_lng      = current_point.GetLng();
//    const double current_distance = GpsCoordinate::DistanceInMeters(current_lat, current_lng, target_lat, target_lng);
//
...
//    double dist;
//    if (SPLIT_BY_X)
//        dist = GpsCoordinate::DistanceInMeters(current_lat, target_lng, target_lat, target_lng);
//    else
//        dist = GpsCoordinate::DistanceInMeters(target_lat, current_lng, target_lat, target_lng);
//
//    if (dist < best_dist)
//    {
...
//    const double current_lat      = current_point.GetLat();
//    const double current_lng      = current_point.GetLng();
//    const double current_distance = GpsCoordinate::DistanceInMeters(current_lat, current_lng, source_lat, source_lng);
//
...
//								GpsCoordinate::DistanceInMeters(current_lat, source_lng, source_lat, source_lng) :
//								GpsCoordinate::DistanceInMeters(source_lat, current_lng, source_lat, source_lng);
//
//    if (dist > radius)
//    {
//        if (SPLIT_BY_X)
